        ...
        {editMode && (
          <div className="bg-[#1a1a24] rounded-xl border border-purple-800 p-6 mb-6">
            ...
            <div className="flex gap-3 mt-4">
              <button onClick={salvar} disabled={actionLoading} className="bg-purple-600 hover:bg-purple-700 disabled:opacity-50 text-white text-sm px-5 py-2 rounded-lg transition">
          ...
          <div className="bg-[#1a1a24] rounded-xl border border-gray-800 p-5">
            ...
            {webhookUrl ? (
              <div className="flex items-center gap-2">
                <code className="text-purple-400 text-sm flex-1 break-all">{webhookUrl}</code>
                <button
                  onClick={copyWebhook}
