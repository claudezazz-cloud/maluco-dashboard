...
export async function PUT(req, { params }) {
  ...
  try {
    ...
    const { nome, chat_id, descricao, ativo, bom_dia, alertas_notion_entrega, alertas_notion_ok } = await req.json()
    const r = await query(
      ...
      [nome ?? null, chat_id ?? null, descricao ?? null, ativo ?? null, bom_dia ?? null, alertas_notion_entrega ?? null, alertas_notion_ok ?? null, id]
    )
